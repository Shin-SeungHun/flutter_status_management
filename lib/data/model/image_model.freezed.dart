...
abstract class $ImageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String imageUrl, String tags});
}
...
class _$ImageModelImpl implements _ImageModel {
  const _$ImageModelImpl(
      {required this.id, required this.imageUrl, required this.tags});
  ...
  @override
  String toString() {
    return 'ImageModel(id: $id, imageUrl: $imageUrl, tags: $tags)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, imageUrl, tags);
...
abstract class _ImageModel implements ImageModel {
  const factory _ImageModel(
      ...
      required final String tags}) = _$ImageModelImpl;
